...
# programs - alacritty balena-etcher blender discord galculator gimp inkscape krita libreoffice-fresh lollypop lutris obs-studio simple-scan steam timeshift visual-studio-code-bin virt-manager virt-viewer vlc yuzu-mainline-bin
